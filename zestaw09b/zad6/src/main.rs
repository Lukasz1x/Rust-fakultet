...
impl Task
{
    fn new(name: String, description: String, priority: Priority, due: Date) -> Self
    {
        Self
        {
            name,
...
fn main() {
    let t2 = Task::new("zadanie".to_string(), "opis".to_string(), Priority::Medium, Date::from_string_with_time("26.05.2025", '.', "08:00:00", ':'));
    println!("{:?}", t2);
    let t = Task {
        name: "Praca domowa Rust".to_string(),
        description: "Zadania z zestawu 09b".to_string(),
        priority: Priority::High,
        due: Date::from_3(22,Month::May,2025)
    };
    let t1 = Task {
        name: "Praca domowa Rust".to_string(),
        description: "Zadania z zestawu 10a".to_string(),
